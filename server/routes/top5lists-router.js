...
const AggregateListController = require('../controllers/aggregatelist-controller');
...
router.post('/aggregatelist', auth.verify, AggregateListController.createAggregateList)
